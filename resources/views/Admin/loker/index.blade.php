                                                    ...
                                                    <div class="col-4">
                                                        <div class="me-n2 my-3 text-start">
                                                            <a class="btn btn-sm bg-0057FF mb-0 w-100"
                                                                href="{{ route('loker.detail', $data->id_loker) }}"
                                                                style="background-color: #0057FF;">
                                                    ...
                                                    <div class="col-4">
                                                        <div class="me-n2 my-3 text-start">
                                                            <a class="btn btn-sm bg-danger mb-0 h-25 w-100"
                                                                ...
                                                                data-bs-target="#hapus{{ $data->id_loker }}"
...
{{-- Modal Hapus --}}
@foreach ($loker as $data)
    <div class="modal fade" id="hapus{{ $data->id_loker }}" tabindex="-1" aria-labelledby="add" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body align-middle text-center">
                    ...
                    <a href="{{ route('loker.destroy', $data->id_loker) }}" class="btn btn-success">Hapus</a>
