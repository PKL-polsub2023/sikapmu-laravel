                                                    ...
                                                    <div class="col-4">
                                                        <div class="me-n2 my-3 text-start">
                                                            <a class="btn btn-sm bg-primary mb-0 w-100"
                                                                href="{{ route('admin.detail', ['jenis' => 'pelopor', 'id' => $data->id]) }}"
                                                                style="background-color: #0057FF;">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="adddoc">Daftar SILAPEM</h5>
...
@foreach ($pelopor as $data)
    ...
    <div class="modal fade" id="edit{{ $data->id }}" tabindex="-1" aria-labelledby="add" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="adddoc">Edit SILAPEM</h5>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body align-middle text-center">
                    ...
                    {{-- <a href="{{ route('pelopor.verifikasi', $data->id) }}" class="btn btn-success">Verifikasi</a> --}}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body align-middle text-center">
                    ...
                    <a href="{{ route('admin.pelopor.destroy', $data->id_user) }}" class="btn btn-success">Hapus</a>
                    <a href="#" class="btn btn-danger" data-bs-dismiss="modal" aria-label="Close">Batalkan</a>
                </div>
            </div>
        </div>
...
<script src="{{ asset('assets/js/pribadi/pelopor-admin.js') }}"></script>
