    ...
    <div class="sidenav-header">
        <a href="{{ route('dashboard') }}" class="nav-link" id="dashboard">
            <div class="profile-img"
                style=" height: 60px; display: flex; justify-content: center; margin: 0 auto;">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link text-white {{ $activePage == 'dashboard2' ? ' active-page' : '' }}  "
                href="{{ route('landingpage') }}"  onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
