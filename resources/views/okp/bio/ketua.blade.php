            ...
            <div class="card card-body mx-3 mx-md-4 mt-n6">
                ...
                <div class="card card-plain h-100">
                    <div class="card-header pb-0 p-3">
                        <div class="row">
                            <div class="col-md-8 d-flex align-items-center">
                                <h6 class="mb-3">Data Ketua Umum</h6>
                            </div>
                        </div>
                    </div>
                    <div class="card-body p-3">
                        ...
                        @endif
                        <form method='POST' action='{{ route('okp.uketua') }}'>
                            @csrf
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="nama_ketua" class="form-control border border-2 p-2"
                                        value='{{ old('nama_ketua', $user->nama_ketua) }}'>
                                    @error('nama_ketua')
