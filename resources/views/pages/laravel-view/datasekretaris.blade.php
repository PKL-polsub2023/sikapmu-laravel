<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <x-navbars.sidebar2 activePage="datasekretaris"></x-navbars.sidebar2>
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.navok titlePage="Data Sekretaris Umum"></x-navbars.navs.navok>
        <!-- End Navbar -->
                    ...
                    <div class="row">
                        <div class="col-7">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="input-group input-group-outline mt-3" style="margin-right: 100px">
                                        <label class="form-label">Jankel</label>
                                        <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                            name="nama">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <div class="input-group input-group-outline mt-3" style="margin-right: 100px">
                                        <label class="form-label">Telp/Np</label>
                                        <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                            name="nama">
                                    </div>
                                </div>
